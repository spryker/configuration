 ...
 * @group Business
 * @group Facade
 * @group GetConfigurationValuesFacadeTest
 * Add your own group annotations below this line
 */
class GetConfigurationValuesFacadeTest extends Unit
{
    ...
    public function testGetConfigurationValuesReturnsDefaultsForAllMatchingKeys(): void
    {
        // Arrange
        $facade = $this->createFacade();
        $requestTransfer = (new ConfigurationValueRequestTransfer())
            ->setKey('catalog:general:display');

        // Act
        $result = $facade->getConfigurationValues($requestTransfer);

        // Assert
        $this->assertArrayHasKey('items_per_page', $result);
        $this->assertArrayHasKey('sort_order', $result);
        $this->assertArrayHasKey('description', $result);
        $this->assertSame('12', $result['items_per_page']);
        $this->assertSame('name_asc', $result['sort_order']);
    ...
    {
        // Arrange
        $this->createConfigurationValueEntity('catalog:general:display:items_per_page', 'global', '50');
        ...
        // Assert
        $this->assertSame('50', $result['items_per_page']);
        $this->assertSame('name_asc', $result['sort_order']);
    }

    public function testGetConfigurationValuesResolvesStoreScopeForEachKey(): void
    {
        // Arrange
        $this->createConfigurationValueEntity('catalog:general:display:items_per_page', 'store', '100', 'DE');
        ...
        // Assert
        $this->assertSame('100', $result['items_per_page']);
        $this->assertSame('name_asc', $result['sort_order']);
    }

    public function testGetConfigurationValuesFallsBackToGlobalScopePerKey(): void
    {
        // Arrange
        $this->createConfigurationValueEntity('catalog:general:display:items_per_page', 'global', '30');
        ...
        // Assert
        $this->assertSame('30', $result['items_per_page']);
    }
    ...
    public function testGetConfigurationValuesReturnsEmptyArrayForUnmatchedPrefix(): void
    {
        ...
        $facade = $this->createFacade();
        $requestTransfer = (new ConfigurationValueRequestTransfer())
            ->setKey('unknown:prefix:that:matches:nothing');
